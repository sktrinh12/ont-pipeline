...
#### Refer to [Manual Pangenom Alignment](./pangenome_alignment.md) to understand better what was done in vg/odgi docker container prior to adopting to nextflow
